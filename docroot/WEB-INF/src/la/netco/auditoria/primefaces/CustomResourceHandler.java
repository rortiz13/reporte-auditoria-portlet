...
public class CustomResourceHandler extends ResourceHandlerWrapper {
	...
	// Public Constants
	public static final String LIBRARY_NAME = "exportDocument";
	...
	public CustomResourceHandler(ResourceHandler wrappedResourceHandler) {
	...
	public void handleResourceRequest(FacesContext facesContext) throws IOException {
		...
		if (LIBRARY_NAME.equals(libraryName) && ExportResource.RESOURCE_NAME.equals(resourceName)) {
