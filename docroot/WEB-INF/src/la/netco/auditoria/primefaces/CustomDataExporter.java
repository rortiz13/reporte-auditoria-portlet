...
public class CustomDataExporter implements ActionListener, StateHolder {
	...
	public void processAction(ActionEvent event){
		...
		try {
			...
			String url = exporter.export(context, table, outputFileName, isPageOnly, isSelectionOnly, encodingType, preProcessor, postProcessor);
			
			url = FacesContext.getCurrentInstance().getExternalContext().encodeResourceURL(url);
			//RequestContext.getCurrentInstance().execute("window.location.href = '" + url + "'");
